...
fn main() {
    ...
    let virtual_address: u64 = 0x8ff3;
    ...
    let cfg: ControlFlowGraph = ControlFlowGraph::from_address_parallel(&binary, virtual_address);
    //    ControlFlowGraph::from_address(&binary, virtual_address);
